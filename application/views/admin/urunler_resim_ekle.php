...
<link href="<?php echo base_url(); ?>assets/admin///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Ürün Resmi Ekleme</a> <i class="fa fa-angle-right"></i></li>
...
<div   class="agileinfo-grap" style="width:100%;"  >  
 	...
 	<!---->
        ...
        <form method="post" action="<?php echo base_url(); ?>/admin/urunler/resim_ekle_kaydet/<?=$id?>" enctype="multipart/form-data"> 
