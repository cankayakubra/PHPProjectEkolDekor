...
<link href="<?php echo base_url(); ?>assets/admin///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a>Üyeler Düzenle</a> <i class="fa fa-angle-right"></i></li>
...
<div   class="agileinfo-grap" style="width:100%;"  >  
 	...
 	<!---->
           ...
           <form method="post" action="<?php echo base_url(); ?>/admin/uyeler/guncelle/<?=$veri[0]->Id?>">
         	<div class="vali-form">
             <div class="col-md-6 form-group1">
              <label class="control-label">Adı Soyadı</label>
              <input type="text" name="adsoy"  value="<?=$veri[0]->adsoy?>" placeholder="adsoy" required="">
            </div>
              ...
              <input type="text" name="email" value="<?=$veri[0]->email?>" placeholder="email" required="">
            </div>
            <div class="clearfix"> </div>
             
            <div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Adres</label>
              <input type="text"  name="adres" value="<?=$veri[0]->adres?>" placeholder="" required="">
            </div>
              <div class="clearfix"> </div>
			   <div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Telefon</label>
              <input type="text"  name="tel" value="<?=$veri[0]->tel?>" placeholder="" required="">
            </div>
              <div class="clearfix"> </div>
              <div class="col-md-12 form-group2 group-mail">
              <label class="control-label" name="sehir" >Sehir</label>
            <select name="sehir"  >
    ...
    <option value="81">Düzce</option>
			...
			<div class="col-md-12 form-group2 group-mail">
              <label class="control-label" name="yetki" >Yetki</label>
            <select name="yetki" >
