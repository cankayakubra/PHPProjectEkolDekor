...
<link href="<?php echo base_url(); ?>assets/admin///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Ürünler Galeri Resmi Ekleme</a> <i class="fa fa-angle-right"></i></li>
...
<div   class="agileinfo-grap" style="width:100%;"  >  
   	...
   	<div class="validation-system">
        ...
        <form method="post" action="<?php echo base_url(); ?>/admin/urunler/resim_galeri_ekle_kaydet/<?=$id?>" enctype="multipart/form-data"> 
		   ...
		   <p class="help-block">
		     ...
		     foreach($veriler as $rs)
			 {
				 ...
				 ?>
						...
						<a >
							<img height="100" width="100" src="<?php echo base_url()?>uploads/<?=$rs->resim?>" >
							 
							
						</a>	
                    		
                  <a href="<?php echo base_url(); ?>/admin/urunler/delete_resim/<?=$id?>/<?=$rs->Id?>" class="hvr-icon-spin col-5">SİL</a>
