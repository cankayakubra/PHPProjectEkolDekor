...
<link href="<?php echo base_url(); ?>assets/admin///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">Sipariş Listesi</a> <i class="fa fa-angle-right"></i></li>
							<?php
				  ...
				  <table id="table-breakpoint">
					...
					?>
					  <tr>
						...
						<td><a href="<?php echo base_url(); ?>admin/siparisler/siparis_detay/<?=$rs->Id?>"   class="hvr-icon-float-away col-24" >Sipariş Detay</a></td>
