...
<link href="<?php echo base_url(); ?>assets/admin///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">Ürünler Ekleme</a> <i class="fa fa-angle-right"></i></li>
...
<div   class="agileinfo-grap" style="width:100%;"  >  
 	...
 	<!---->
        ...
        <form method="post" action="<?php echo base_url(); ?>/admin/urunler/ekle_kaydet">
         	<div class="vali-form">
            <div class="col-md-6 form-group1">
              <label class="control-label">Ürün Kodu</label>
              <input type="text" name="kodu"  placeholder="kodu" required="">
            </div>
            <div class="col-md-6 form-group1 form-last">
              <label class="control-label">Adı</label>
              <input type="text" name="adi" placeholder="adi" required="">
            </div>
            ...
            <div class="col-md-12 form-group1 group-mail">
              ...
              <input type="text"  name="turu" placeholder="turu" required="">
            </div>
             <div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Satış Fiyatı</label>
              <input type="text"  name="sfiyat" placeholder="sfiyat" required="">
             <div class="clearfix"> </div>
			  <div class="clearfix"> </div>
