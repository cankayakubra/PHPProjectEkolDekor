...
<link href="<?php echo base_url(); ?>assets/admin///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">Ürün Listesi</a> <i class="fa fa-angle-right"></i></li>
				<li><a href="<?php echo base_url(); ?>admin/urunler/ekle" class="hvr-icon-float-away col-24">Ürün EKLE</a></li>
				  ...
				  <table id="table-breakpoint">
					...
					?> 
					  <tr>
						...
						<td> <a class="hvr-icon-float-away col-24" href="<?php echo base_url()?>admin/urunler/resim_galeri_ekle/<?=$rs->Id ?>"><img height="30"  src="<?php echo base_url()?>assets/admin/images/image_galery.png"> </a> </td>
						
						<td><a href="<?php echo base_url(); ?>admin/urunler/duzenle/<?=$rs->Id?>" class="hvr-icon-float-away col-24" >Düzenle</a></td>
						<td><a href="<?php echo base_url(); ?>admin/urunler/sil/<?=$rs->Id?>"  onclick="return confirm(' Silmek istediğinize Emin Misin?')" class="hvr-icon-float-away col-24" >Sil</a></td>
