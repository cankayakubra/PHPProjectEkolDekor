...
<link href="<?php echo base_url(); ?>assets/admin///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">Kategoriler Ekleme</a> <i class="fa fa-angle-right"></i></li>
...
<div   class="agileinfo-grap" style="width:100%;"  >  
 	...
 	<!---->
        ...
        <form method="post" action="<?php echo base_url(); ?>/admin/kategoriler/ekle_kaydet">
         	<div class="vali-form">
