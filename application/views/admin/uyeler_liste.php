...
<link href="<?php echo base_url(); ?>assets/admin///fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
		...
		<div class="container">
			<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">üye Listesi</a> <i class="fa fa-angle-right"></i></li>
				<li><a href="<?php echo base_url(); ?>admin/uyeler/ekle" class="hvr-icon-float-away col-24">Üye EKLE</a></li>
				  ...
				  <table id="table-breakpoint">
					...
					?> 
					  <tr>
						...
						<td><?=$rs->yetki?></td>
						<td><?=$rs->durum?></td>
						<td><a href="<?php echo base_url(); ?>admin/uyeler/duzenle/<?=$rs->Id?>" class="hvr-icon-float-away col-24" >Düzenle</a></td>
						<td><a href="<?php echo base_url(); ?>admin/uyeler/sil/<?=$rs->Id?>"  onclick="return confirm(' Silmek istediğinize Emin Misin?')" class="hvr-icon-float-away col-24" >Sil</a></td>
